...
function respond() {
  var request = JSON.parse(this.req.chunks[0]),
      ...
      botRegexP = /^\/PDL/i;  botRegexTw = /^\/twitch/i; botRegexSh = /^\/trade/; botRegexWk = /^\/users/; botRegexCC = /^\/cc/;
      botRegexSiege = /^\/siege/; botRegexOW = /^\/ratings/; 
      botRegexSlut = /^\/slut/; botRegexMason = /^\/4th/;
      botRegexProp = /^\/prop/;botRegexKys = /^\/kys/; botRegexSlam = /^\/alert/; botRegexBrye = /^\/brye/;
      botRegexGian = /^\/gian/; botRegexScrotes = /^\/scrotes/; botRegexShaki = /^\/shaki/;
      botRegexDaf = /^\/dafuq/; botRegexMA32 = /^\/pending/; botRegexTrade = /^\//; 
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://https://daddyleagues.com/som/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("http://daddyleagues.com/som/blog/news/18521/FOR-THE-NON-INTERNET-SAVVY");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://daddyleagues.com/som/rules");
    this.res.end();
  } 
    ...
    postMessage("https://daddyleagues.com/som/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("https://daddyleagues.com/som/players?name="+rep+"&position=all&team=all");
